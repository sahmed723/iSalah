...
struct PrayerTime {
    ...
    static var samples: [PrayerTime] {
        let fajr = PrayerTime(salah: "Fajr", time: "05:25 AM")
        let dhuhr = PrayerTime(salah: "Dhuhr", time: "12:59 PM")
        let asr = PrayerTime(salah: "Asr", time: "04:55 PM")
        let maghrib = PrayerTime(salah: "Maghrib", time: "08:12 PM")
        let isha = PrayerTime(salah: "Isha", time: "10:02 PM")
